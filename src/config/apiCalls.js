...
export function recentlyAddedPDFPage() {
  return fetch(
    "http://ec2-52-66-201-52.ap-south-1.compute.amazonaws.com:5000/recently_added_books?book_type=PDF"
  );
}
...
export function audioBookUrl(titleName) {
  return axios.get(
    "http://ec2-52-66-201-52.ap-south-1.compute.amazonaws.com:5000/search?bookType=Audio_Book&book_name=" +
    titleName
  );
}
...
export function recentlyAddedAudioPage() {
  return fetch(
    "http://ec2-52-66-201-52.ap-south-1.compute.amazonaws.com:5000/recently_added_books?book_type=AUDIO_BOOK"
  );
}
