...
export function HomePageBooksPDF(currentUserId) {
  return fetch(
    "http://ec2-65-1-112-155.ap-south-1.compute.amazonaws.com:5000/home_page_books?user_id=" +
    currentUserId +
    "&book_type=PDF"
  );
}
...
export function readPDF(file_name) {
  return axios.get(
    "http://ec2-65-1-112-155.ap-south-1.compute.amazonaws.com:5000/download_url?file_name=" +
    file_name +
    ".pdf"
  );
}
...
export function recentlyAddedPDFPage() {
  return fetch(
    "http://ec2-65-1-112-155.ap-south-1.compute.amazonaws.com:5000/recently_added_books?book_type=PDF"
  );
}

export function bookmarkedPDFPage(currentUserId) {
  return fetch(
    "http://ec2-65-1-112-155.ap-south-1.compute.amazonaws.com:5000/users/" +
    currentUserId +
...
export function savePDFCall(requestBody, requestConfig) {
  return axios.post(
    "http://ec2-65-1-112-155.ap-south-1.compute.amazonaws.com:5000/bookmarked_books",
    requestBody,
    requestConfig
  );
}
...
export function recentlyViewedPDFCall(requestBody, requestConfig) {
  return axios.post(
    "http://ec2-65-1-112-155.ap-south-1.compute.amazonaws.com:5000/recently_viewed_books",
    requestBody,
    requestConfig
  );
}
...
export function audioBookUrl(titleName) {
  return axios.get(
    "http://ec2-65-1-112-155.ap-south-1.compute.amazonaws.com:5000/search?bookType=Audio_Book&book_name=" +
    titleName
  );
}
...
export function recentlyAddedAudioPage() {
  return fetch(
    "http://ec2-65-1-112-155.ap-south-1.compute.amazonaws.com:5000/recently_added_books?book_type=AUDIO_BOOK"
  );
}
...
export function searchCall(searchBook) {
  return axios.get(
    "http://ec2-65-1-112-155.ap-south-1.compute.amazonaws.com:5000/search",
    {
...
export function getAuthorList() {
  return fetch(
    "http://ec2-65-1-112-155.ap-south-1.compute.amazonaws.com:5000/authors"
  );
}

export function getCategoryList() {
  return fetch(
    "http://ec2-65-1-112-155.ap-south-1.compute.amazonaws.com:5000/book_categories?"
  );
}

export function postPdf(bookDetails, requestConfig) {
  return axios.post(
    "http://ec2-65-1-112-155.ap-south-1.compute.amazonaws.com:5000/books",
    bookDetails,
    requestConfig
  );
}
